...
#menuWrap .bookmark p{background:url(<%=util.Property.contextPath%>/img/admin/ico_bookmark.png) no-repeat 0 center; color:<%=util.Property.color%>; padding:0 20px; font-size:15px; font-weight:600; width:100%; position:relative;}
...
#menuWrap .bookmark li{background:url(<%=util.Property.contextPath%>/img/admin/menu_2dep_off.png) no-repeat 20px center; padding:4px; padding-left:35px; font-size:14px; cursor:pointer;}
#menuWrap .gnb{}
#menuWrap .gnb dt{background:url(<%=util.Property.contextPath%>/img/admin/menu_off.png) no-repeat 20px center; padding:15px 20px; padding-left:45px; color:#161f2c; font-size:15px; font-weight:400; border-top:1px solid #ffffff; border-bottom:1px solid #dddddd;}
#menuWrap .gnb dt.on{background:<%=util.Property.color%> url(<%=util.Property.contextPath%>/img/admin/menu_on.png) no-repeat 20px center; color:#fff;}
#menuWrap .gnb dd{background:#e6e6e6; padding:10px 20px; display:none;}
#menuWrap .gnb dd li{background:url(<%=util.Property.contextPath%>/img/admin/menu_2dep_off.png) no-repeat 25px center; padding:4px; padding-left:40px; font-size:15px;}
#menuWrap .gnb dd li.on{background:url(<%=util.Property.contextPath%>/img/admin/menu_2dep_on.png) no-repeat 25px center; color:<%=util.Property.color%>; font-size: 16px; font-weight: 400;}
...
.scheduleSearch .date input[type=button]{width:32px; height:32px; background:#bfbfbf url('<%=util.Property.contextPath%>/img/admin/btn_calender.png') no-repeat center center;}
.scheduleSearch .search{width:100px; border:none; height:32px; background:#515151 url('<%=util.Property.contextPath%>/img/admin/btn_search.png') no-repeat 18px center; padding:0; padding-left:38px; width:85px; color:#fff !important; font-size:14px; }
...
.linkSearch .search{width:100px; border:none; height:32px; background:#515151 url('<%=util.Property.contextPath%>/img/admin/btn_search.png') no-repeat 18px center; padding:0; padding-left:38px; width:85px; color:#fff !important; font-size:14px; }
...
.linkBox li.link01{background:#f5f5f5 url(<%=util.Property.contextPath%>/img/admin/main_link01.png) no-repeat 20px center; padding-left:50px; border:1px solid #dddddd;}
.linkBox li.link02{background:#f5f5f5 url(<%=util.Property.contextPath%>/img/admin/main_link02.png) no-repeat 20px center; padding-left:50px; border:1px solid #dddddd;}
.linkBox li.link03{background:#f5f5f5 url(<%=util.Property.contextPath%>/img/admin/main_link03.png) no-repeat 20px center; padding-left:50px; border:1px solid #dddddd;}
...
.selectric-dSelect .button{right:10px;top:12px;width:12px;height:7px;background:url("<%=util.Property.contextPath%>/img/admin/list_arrow.png") no-repeat left top}
