...
<%@ include file="/WEB-INF/views/includes/header.jsp" %>
	...
	<div class="container">
		...
		<div class="bodytext_area box_inner">
			...
			<div>
				<input type="checkbox" name="best" value="4">best
				<input type="checkbox" name="review" value="5">여행후기
				<input type="checkbox" name="recommand" value="6">맛집추천
				<input type="checkbox" name="worry" value="7">고민
			</div>
