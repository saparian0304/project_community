...
function makeTh(sort, order) {
	var arr1 = ['member_id', 'nickname', 'email', 'gender', 'birthday', 'level', 'out', 'board_count', 'reply_count', 'regdate', 'curr_login'];
	var arr2 = ['ID', '닉네임', '이메일', '성별', '생년월일', '등급', '회원상태', '게시글 수', '댓글 수', '가입일', '최근방문일'];
